...
public class Text_Field_Input {
    ...
    public static void addPanel5() {
        ...
        WindowVar.Panel5.add(WindowVar.P5_File_Dir_Text_Field);
        ...
        Text_Box_Settings(WindowVar.P5_File_Dir_Text_Field);
